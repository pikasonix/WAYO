...
export function useMapControls() {
    ...
    const routingCacheRef = useRef(new Map<string, any>()); // Use ref for mutable cache

    const generateCacheKey = useCallback((startCoord: [number, number], endCoord: [number, number]): string => {
