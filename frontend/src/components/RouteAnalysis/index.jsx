...
const RouteAnalysis = ({ solution, instance, onRouteSelect }) => {
    ...
    useEffect(() => {
        if (solution?.routes && instance?.nodes) {
            ...
            const analysisResults = solution.routes.map((route, index) => {
    ...
    const calculateRouteMetrics = (route, instance) => {
    ...
    const getRouteStatusColor = (violations) => {
    ...
    const getRouteQualityBadge = (route) => {
