import TrackAsiaTrafficLayer from "./TrackAsiaTrafficLayer.js";
...
class TrackAsiaService {
    ...
    async initializeMap(containerId, options = {}) {
        try {
            ...
            this.traffic = new TrackAsiaTrafficLayer({
                showTraffic: true,
                showIncidents: true,
    ...
    toggleTrafficLayer() {
        if (!this.map || !this.traffic) return false;
        // Use our custom traffic layer toggle method
        const isVisible = this.traffic.toggleTraffic();
        this.trafficVisible = isVisible;
